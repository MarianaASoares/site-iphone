    ...
    return (
        <nav className="fixed top-0 w-full bg-black/80 backdrop-blur-md z-50">
            <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-center gap-4 md:gap-8">
                ...
                <a href="#performance" className="hover:text-gray-300 text-sm md:text-lg">Performance</a>
                <a href="#cores" className="hover:text-gray-300 text-sm md:text-lg">Cores</a>
