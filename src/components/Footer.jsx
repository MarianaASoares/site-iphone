                        ...
                        <div key={index}>
                            ...
                            <ul className="space-y-2 text-sm text-gray-400">
                                {section.links.map((link, linkIndex) => (
                                    <li key={linkIndex}>
                                        <a href="#" className="hover:text-white cursor-pointer transition-all duration-300">{link}</a>
                                    </li>
                                ))}
                            </ul>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex gap-6  text-gray-400">
                            {buttomLinks.map((link, index) => (
                                <a href="#" key={index} className="hover:text-white transition-all duration-300 cursor-pointer">{link}</a>
                            ))}
                        </div>
                    </div>
